  ...
  <div class="volunteer-team">
    ...
    <section class="py-[120px] max-md:py-[100px] text-center bg-white border-b border-border">
      <div class="max-w-[1200px] mx-auto px-6">
        <h1 class="text-[2.4rem] max-md:text-[1.8rem] font-extrabold mb-4">志愿队</h1>
    ...
    <section class="py-20 max-md:py-12">
      <div class="max-w-[1200px] mx-auto px-6">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold text-center mb-3">志愿队是什么</h2>
    ...
    <section class="py-20 max-md:py-12 bg-bg border-y border-border">
      <div class="max-w-[1200px] mx-auto px-6">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold text-center mb-3">志愿队做什么</h2>
        ...
        <div class="grid grid-cols-2 max-md:grid-cols-1 gap-6">
          <!-- 项目部 -->
          <div class="border border-border rounded-sm p-8 bg-white">
            <div class="mb-4">
            ...
            <h3 class="text-lg font-semibold mb-2">项目部：活动的"智慧大脑"</h3>
            <div class="text-[15px] leading-relaxed text-text-secondary space-y-3">
              ...
              <p>
                <strong class="text-text">加入项目部，你能收获：</strong>系统学习活动策划方法论，提升沟通能力和组织协调能力，增强逻辑思维和细节把控能力，掌握推文撰写、图片编辑和新媒体运营等实用技能。
              </p>
            </div>
          </div>
          ...
          <div class="border border-border rounded-sm p-8 bg-white">
            ...
            <h3 class="text-lg font-semibold mb-2">活动部：现场的"执行能手"</h3>
            <div class="text-[15px] leading-relaxed text-text-secondary space-y-3">
              <p>
              ...
              <p>
                <strong class="text-text">在活动部，你将收获：</strong>学习志愿者管理技巧，锻炼应急处理能力和应变能力，在与师生的直接互动中收获满满的成就感和幸福感。
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="py-20 max-md:py-12">
      <div class="max-w-[1200px] mx-auto px-6">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold text-center mb-3">往期工作回顾</h2>
        ...
        <div class="grid grid-cols-3 max-md:grid-cols-1 gap-6">
          <div class="border border-border rounded-sm p-8 text-center">
            ...
            <h3 class="text-lg font-semibold mb-2">前期</h3>
          ...
          <div class="border border-border rounded-sm p-8 text-center">
            ...
            <h3 class="text-lg font-semibold mb-2">中期</h3>
            <p class="text-[15px] leading-relaxed text-text-secondary">
          ...
          <div class="border border-border rounded-sm p-8 text-center">
            ...
            <h3 class="text-lg font-semibold mb-2">后期</h3>
            <p class="text-[15px] leading-relaxed text-text-secondary">
    ...
    <section class="py-20 max-md:py-12 bg-bg border-y border-border">
      <div class="max-w-[1200px] mx-auto px-6">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold text-center mb-3">活动风采</h2>
    ...
    <section class="py-20 max-md:py-12">
      <div class="max-w-[1200px] mx-auto px-6">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold text-center mb-3">电脑义诊</h2>
        <p class="text-base text-text-secondary text-center mb-12 max-w-[640px] mx-auto">为你的数字生活保驾护航！</p>

        <div class="border border-border border-l-[3px] border-l-text-secondary rounded-r-sm p-6 bg-white mb-8">
          <p class="text-[17px] font-semibold mb-2">
            你的电脑卡顿、蓝屏、中毒？别急，义诊来帮你！
          </p>
          <p class="text-[15px] leading-relaxed text-text-secondary">
            现代教育技术学院联合计算机与网络技术协会、数字素养与技能提升志愿者服务队，推出<strong class="text-text">免费电脑义诊服务</strong>，为全校师生解决各类电脑问题！
          </p>
        </div>
    ...
    <section class="py-20 max-md:py-12 bg-bg border-y border-border">
      <div class="max-w-[1200px] mx-auto px-6">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold text-center mb-3">相亲相爱一家人</h2>
    ...
    <section class="py-20 max-md:py-12 text-center">
      <div class="max-w-[1200px] mx-auto px-6">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold mb-3">期待你的加入</h2>
