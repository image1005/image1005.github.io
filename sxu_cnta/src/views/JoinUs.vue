...
<template>
  <div class="join-us">
    ...
    <section class="py-20 max-md:py-12">
      <div class="max-w-[1200px] mx-auto px-6">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold text-center mb-3 text-text dark:text-white">扫码加入我们的大家庭</h2>
        <p class="text-base text-text-secondary dark:text-gray-400 text-center mb-12 max-w-[640px] mx-auto">选择你感兴趣的部门，开启 CNTA 之旅</p>
        ...
        <div class="grid grid-cols-2 max-md:grid-cols-1 gap-6 max-w-[800px] mx-auto">
          ...
          <TiltCard class="border border-border dark:border-neutral-700 rounded-sm p-8 text-center">
            ...
            <h3 class="text-lg font-semibold mb-2 text-text dark:text-white">CNTA 总群</h3>
            <p class="text-[15px] leading-relaxed text-text-secondary dark:text-gray-400 mb-5">
          ...
          <TiltCard class="border border-border dark:border-neutral-700 rounded-sm p-8 text-center">
            ...
            <h3 class="text-lg font-semibold mb-2 text-text dark:text-white">学习资源</h3>
            <p class="text-[15px] leading-relaxed text-text-secondary dark:text-gray-400 mb-5">
    ...
    <section class="py-20 max-md:py-12 bg-bg dark:bg-neutral-900 border-y border-border dark:border-neutral-700">
      <div class="max-w-[1200px] mx-auto px-6 text-center">
        <h2 class="text-[2rem] max-md:text-[1.5rem] font-bold mb-3 text-text dark:text-white">联系我们</h2>
        <div class="max-w-[400px] mx-auto leading-[2.4] text-text-secondary dark:text-gray-400">
          <p>东山校区思创楼B座B203</p>
          <p>大同校区紫光楼</p>
          <p>现代教育技术学院</p>
        </div>
